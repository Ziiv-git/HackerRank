'''
Task:- A Node class is provided for you in the editor. A Node object has an integer
...
occur twice in the list, so we remove the two duplicate nodes. We then return our
updated (ascending) list, which is {1, 2, 3, 4}.
'''
